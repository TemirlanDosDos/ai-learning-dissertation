const ai07 = {
  ...
  <section class="lesson-section intro">
    ...
    <p>
      <em>
        Бұл сабақта сіз Gemini-ге мәтін арқылы тапсырма беріп,
  ...
  <section class="lesson-section">
    ...
    <p>
      ...
      дайын бағдарламалық код алу.
    </p>

    <ul>
      <li>Бағдарлама жаздыру</li>
      <li>Ойын жасау</li>
  ...
  <section class="lesson-section">
    ...
    <ul>
      <li>Google аккаунт қажет</li>
      <li>Көп бағдарламалау тілін біледі</li>
...
Python тілінде
matplotlib қолданып,
математикалық формула арқылы
жүрек пішінін салатын код жаз.
График әдемі көрінуі керек.
    ...
    <pre>
HTML және CSS қолданып,
заманауи, стильді бір беттен тұратын сайт жаса.
Gradient фон, үлкен тақырып,
анимация және әдемі батырма болсын.
Код толық дайын болсын.
    ...
    <pre>
Python тілінде pygame қолданып,
классикалық Pong ойынын жаз.
Екі ракетка, доп,
қозғалыс және ұпай санау болсын.
Код толық жұмыс істесін.
  ...
  <section class="lesson-section conclusion">
    ...
    <ul>
      ...
      <li>ИИ-ді программист ретінде қолдануды бастадыңыз</li>
    </ul>
