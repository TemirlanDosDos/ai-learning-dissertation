const ai01 = {
  ...
  content: `
    ...
    <p><strong>Ұзақтығы:</strong> ~40 минут

    <p><em>Бұл сабақта сіз жасанды интеллектпен мәтін арқылы жұмыс істеуді нөлден бастап үйренесіз.</em></p>
...
Жасанды интеллект деген не? Қарапайым тілмен түсіндір.
    ...
    <img
      src="/assets/aiLessons/ai01/2.jpg"
      alt="AI ML DL Diagram"
      style="max-width:20%; margin:20px 0;"
    />
...
Маған күнделікті уақытты дұрыс жоспарлау үшін 5 кеңес бер.
    ...
    <img
      src="/assets/aiLessons/ai01/4.jpg"
      alt="AI ML DL Diagram"
      style="max-width:20%; margin:20px 0;"
    />
    ...
    <p>
  ❌ Қате промпт: <code>Маған мәтін жазып бер</code>
</p>
<p>
  Неге қате?
</p>
...
<p>
  ...
  <code>
    ...
    <img
      src="/assets/aiLessons/ai01/bad.jpg"
      alt="AI ML DL Diagram"
