const ai08 = {
  ...
  <section class="lesson-section intro">
    ...
    <p>
      <em>
        Бұл сабақта сіз Grok қосымшасын орнатып,
        Imaging бөлімінде мәтіндік промпт арқылы
  ...
  <section class="lesson-section">
    ...
    <p>
      ...
      визуалды контент —
      сурет немесе 3–5 секундтық видеоны
      жасанды интеллект көмегімен генерациялау.
    </p>

    <ul>
      <li>Идеяны мәтінмен сипаттау</li>
  ...
  <section class="lesson-section">
    ...
    <p>
      Grok Imaging браузерде толық жұмыс істемейді,
      сондықтан <strong>міндетті түрде Grok қосымшасын орнату қажет</strong>.
    </p>

    <ul>
      <li>Телефонға Grok қосымшасын жүктеңіз</li>
      <li>Қосымшаны ашып, аккаунтқа кіріңіз</li>
  ...
  <section class="lesson-section examples">
    ...
    <pre>
Cinematic futuristic city at night,
neon lights, wet streets,
...
digital art style.
  ...
  <section class="lesson-section mistakes">
    ...
    <p>
      ❌ <code>Make video</code><br/>
      ❌ <code>Beautiful scene</code>
    </p>

    <p>
      Себебі: стиль, объект және атмосфера нақты көрсетілмеген.
    </p>
