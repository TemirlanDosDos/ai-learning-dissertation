const ai04 = {
  ...
  content: `
    ...
    <p>
      <em>
        Бұл сабақта сіз ChatGPT ішіндегі
        дауыс арқылы мәтін енгізу функциясын
    ...
    <ul>
      <li>Ұзын мәтінді термей, айтып жазу үшін</li>
      <li>Ойды тез фиксациялау үшін</li>
      <li>Телефонда немесе жолда қолдану үшін</li>
    ...
    <pre>
Сөйлеу → ChatGPT → Мәтін
    </pre>

    <p>
      ChatGPT сіздің даусыңызды тыңдап,
    ...
    <ol>
      ...
      <li>Анық және жай сөйлей бастаңыз</li>
      <li>Сөйлеуді тоқтатыңыз</li>
...
Айтып жазу → мәтін пайда болады → кейін өңдеу немесе нақты тапсырма беру
    ...
    <ul>
      ...
      <li>Черновик пен ой жинауға ыңғайлы</li>
    </ul>
