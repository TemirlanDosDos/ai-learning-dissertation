...
Сурет + нұсқау → Gemini → Жаңа сурет
    ...
    <h3> Мысал сурет:</h3><img
      src="/assets/aiLessons/ai05/1.jpg"
      alt="AI ML DL Diagram"
...
Қалған бөлігін өзгертпе.
    ...
    <img
      src="/assets/aiLessons/ai05/2.jpg"
      alt="AI ML DL Diagram"
      style="max-width:35%; margin:20px 0;"
    />
...
оның орнына ашық, минималистік фон қой.
    ...
    <img
      src="/assets/aiLessons/ai05/3.jpg"
      alt="AI ML DL Diagram"
      style="max-width:35%; margin:20px 0;"
    />
...
Жұмсақ түстер қолдан.
    ...
    <img
      src="/assets/aiLessons/ai05/4.jpg"
      alt="AI ML DL Diagram"
      style="max-width:35%; margin:20px 0;"
    />
    ...
    <p>
      Себебі: нақты не өзгеретіні айтылмаған.
    </p>
    ...
    <!-- IMAGE 6 -->
    <!-- СУРЕТ: түсініксіз нәтиже vs нақты нәтиже -->
