const ai03 = {
  ...
  content: `
    ...
    <p>
      <em>
        Бұл сабақта сіз ElevenLabs сайтында
        ешқандай тіркеусіз-ақ мәтінді
    ...
    <p>
      ...
      дыбысқа айналдыру процесі.
    </p>

    <ul>
      <li>Видеоға дауыс жазу</li>
      <li>Аудио әңгіме жасау</li>
    ...
    <p>
      Сайт ашылғаннан кейін жоғарғы мәзірден
    ...
    <ul>
      ...
      <li><strong>Voice таңдау</strong> — дауыс түрін таңдау</li>
      <li><strong>Language</strong> — тіл таңдау (Kazakh)</li>
    ...
    <ol>
      ...
      <li>Language тізімінен <strong>Kazakh</strong> таңдаңыз</li>
      <li>Дауыс түрін таңдаңыз (мысалы: David немесе Jenny)</li>
    ...
    <pre>
Сәлеметсіз бе.
Бұл — заманауи жасанды интеллект арқылы
жасалған дауыс.
Дауыс сабырлы, сенімді және кәсіби болуы керек.
    </pre>
  ...
  <source src="/assets/aiLessons/ai03/11.mp3" type="audio/mpeg">
    ...
    <pre>
Ертеде, жел сыбдырлаған далада,
адамдар арман мен үмітке толы өмір сүрді.
Дауыс жылы, баяу және әңгіме айтып тұрғандай болуы керек.
    </pre>
  ...
  <source src="/assets/aiLessons/ai03/22.mp3" type="audio/mpeg">
    ...
    <pre>
Бүгін — жаңа мүмкіндік.
Алға қадам жасап,
өз арманыңызға жақындауға
дәл қазір уақыт келді.
Дауыс шабыттандыратын және сенімді болуы керек.
    </pre>
