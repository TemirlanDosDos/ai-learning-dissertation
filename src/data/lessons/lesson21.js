const lesson21 = {
  ...
  content: `
    ...
    <table>
      ...
      <tbody>
        <tr>
          <td><code>data.head(5)</code></td>
          <td>Деректердің форматын көру үшін алғашқы 5 жолды шығарады.</td>
        </tr>
        <tr>
          <td><code>data.info()</code></td>
          <td>Бағандардың деректер типін және бос (null) мәндердің санын көрсетеді.</td>
        </tr>
        <tr>
          <td><code>data.describe()</code></td>
          <td>Сандық деректердің статистикасын (орташа мән, мин, макс) есептейді.</td>
        </tr>
      </tbody>
    </table>
