    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td>Мәндерді <code>[-1, 1]</code> аралығында қысады. Деректердің өзін модуляциялау үшін қолданылады.</td>
        </tr>
        <tr>
          <td><code>recurrent_activation</code></td>
          <td><strong>sigmoid</strong></td>
          <td>Мәндерді <code>[0, 1]</code> аралығында шығарады. Қақпалардың «ашық» немесе «жабық» екенін анықтайды.</td>
        </tr>
      </tbody>
    </table>
